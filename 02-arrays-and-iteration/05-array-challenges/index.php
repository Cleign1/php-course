...
$job_listings = [
  ...
  [
    ...
    'contact_email' => 'careers@creativeagency.com',
...
$new_listing = [
  ...
  'contact_email' => 'hr@businesscorp.com',
  'contact_phone' => '555-4321',
  'skills' => ['Leadership', 'Communication', 'Agile']
];

array_push($job_listings, $new_listing);

echo 'The job title of the second listing is: ' . $job_listings[1]['job_title'] . '<br>';
echo 'The first skill of the third listing is: ' . $job_listings[2]['skills'][0] . '<br>';